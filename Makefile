...
gobj=$(gobj_cu:.c=.o)
out=fcount
CPFLAGS=-I/opt/net/apps/cuda/include -I/opt/net/apps/cudd/include -g -Wall -Werror -funsigned-char# -DNDEBUG #-DNTIMING
CFLAGS=${CPFLAGS}
NVCFLAGS=-arch=sm_20 -g --compiler-options -I/opt/net/apps/cuda/include --compiler-options -Wall --compiler-options -Werror -ccbin ${CC} --compiler-options -funsigned-char # --compiler-options -DNDEBUG --ptxas-options=-v #--compiler-options -DNTIMING  
PYLIB=_fsim.so
